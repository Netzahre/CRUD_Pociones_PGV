...
public class ManejadorCliente implements Runnable {
    ...
    public void run() {
        try (ObjectInputStream entrada = new ObjectInputStream(socket.getInputStream());
            ...
            while (true) {
                ...
                // Switch para manejar los comandos
                switch (comando) {
                    ...
                    case "CREAR_POCION":
                        crearPocion(entrada, salida, crudPoc);
                        break;
                    ...
                    case "MODIFICAR_POCION":
                        modificarPocion(entrada, salida, crudPoc);
                        break;
     ...
     * @param salida  Flujo de salida para enviar la confirmación
     * @param crudPoc Objeto para acceder a la base de datos de pociones
     * @throws IOException            Error al enviar la confirmación
     * @throws ClassNotFoundException Error al recibir la nueva poción
     */
    private void crearPocion(ObjectInputStream entrada, ObjectOutputStream salida, PocionesCRUD crudPoc) throws IOException, ClassNotFoundException {
        entrarAEscribir();
     ...
     * @throws ClassNotFoundException Error al recibir la nueva poción
     */
    private void modificarPocion(ObjectInputStream entrada, ObjectOutputStream salida, PocionesCRUD crudPoc) throws IOException, ClassNotFoundException {
        entrarAEscribir();
